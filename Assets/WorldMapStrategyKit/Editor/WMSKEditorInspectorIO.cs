...
namespace WorldMapStrategyKit {
    ...
    public partial class WMSKEditorInspector {
        ...
        static void CheckBackup(out string geoDataFolder) {
            ...
            fullFileName = geoDataFolder + "/countries110_bin.txt";
            if (File.Exists(fullFileName)) {
                AssetDatabase.CopyAsset(fullFileName, backupFolder + "/countries110_bin.txt");
            }
            fullFileName = geoDataFolder + "/countries10.txt";
            if (File.Exists(fullFileName)) {
                AssetDatabase.CopyAsset(fullFileName, backupFolder + "/countries10.txt");
            }
            fullFileName = geoDataFolder + "/countries10_bin.txt";
            if (File.Exists(fullFileName)) {
                AssetDatabase.CopyAsset(fullFileName, backupFolder + "/countries10_bin.txt");
            }
            ...
            fullFileName = geoDataFolder + "/provinces10_bin.txt";
            if (File.Exists(fullFileName)) {
                AssetDatabase.CopyAsset(fullFileName, backupFolder + "/provinces10_bin.txt");
            }
            ...
            fullFileName = geoDataFolder + "/cities10_bin.txt";
            if (File.Exists(fullFileName)) {
                AssetDatabase.CopyAsset(fullFileName, backupFolder + "/cities10_bin.txt");
            }
        ...
        bool SaveMapChanges() {
            ...
            if (_editor.countryChanges) {
                if (_map.geodataFormat == GEODATA_FORMAT.BinaryFormat) {
                    dataFileName = _editor.GetCountryGeoDataBinaryFileName();
                    ...
                    fullPathName = GetAssetsFolder() + geoDataFolder + "/" + dataFileName;
                    File.WriteAllText(fullPathName, _map.GetCountriesGeodata(), Encoding.UTF8);
                }
            ...
            if (_editor.provinceChanges) {
                if (_map.geodataFormat == GEODATA_FORMAT.BinaryFormat) {
                    dataFileName = _editor.GetProvinceGeoDataBinaryFileName();
                    fullPathName = GetAssetsFolder() + geoDataFolder + "/" + dataFileName;
                    File.WriteAllBytes(fullPathName, _map.GetProvincesGeodataBinary());
                } else {
                    dataFileName = _editor.GetProvinceGeoDataFileName();
                    fullPathName = GetAssetsFolder() + geoDataFolder + "/" + dataFileName;
                    File.WriteAllText(fullPathName, _map.GetProvincesGeodata(), Encoding.UTF8);
                }
            ...
            if (_editor.cityChanges) {
                ...
                if (_map.geodataFormat == GEODATA_FORMAT.BinaryFormat) {
                    dataFileName = _editor.GetCityGeoDataBinaryFileName();
                    fullPathName = GetAssetsFolder() + geoDataFolder + "/" + dataFileName;
                    File.WriteAllBytes(fullPathName, _map.GetCitiesGeodataBinary());
                } else {
                    dataFileName = _editor.GetCityGeoDataFileName();
                    fullPathName = GetAssetsFolder() + geoDataFolder + "/" + dataFileName;
                    File.WriteAllText(fullPathName, _map.GetCitiesGeodata(), Encoding.UTF8);
                }
