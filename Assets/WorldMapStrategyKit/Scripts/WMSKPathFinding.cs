...
namespace WorldMapStrategyKit {
    ...
    _pathFindingWaterMap;
        ...
        /// <param name="ignoreStartingTerrainType">If true, the unit will be able to move one step ignoring the terrain type it's at the start position.</param>
        public List<Vector2> FindRoute(string startCityName, string startCountryName, string endCityName, string endCountryName, TERRAIN_CAPABILITY terrainCapability = TERRAIN_CAPABILITY.Any, float minAltitude = 0, float maxAltitude = 1f, float maxSearchCost = -1, int maxSearchSteps = -1, bool ignoreStartingTerrainType = true) {
            City city1 = GetCity(startCityName, startCountryName);
            City city2 = GetCity(endCityName, endCountryName);
            if (city1 == null || city2 == null)
                return null;
            return FindRoute(city1, city2, terrainCapability, minAltitude, maxAltitude, maxSearchCost, maxSearchSteps, ignoreStartingTerrainType);
        }
        ...
        /// <param name="maxSearchCost">Maximum search cost for the path finding algorithm. A value of -1 will use the global default defined by pathFindingMaxCost</param>
        /// <param name="ignoreStartingTerrainType">If true, the unit will be able to move one step ignoring the terrain type it's at the start position.</param>
        public List<Vector2> FindRoute(City startCity, City endCity, TERRAIN_CAPABILITY terrainCapability = TERRAIN_CAPABILITY.Any, float minAltitude = 0, float maxAltitude = 1f, float maxSearchCost = -1, int maxSearchSteps = -1, bool ignoreStartingTerrainType = true) {
            if (startCity == null || endCity == null)
                return null;
            return FindRoute(startCity.unity2DLocation, endCity.unity2DLocation, terrainCapability, minAltitude, maxAltitude, maxSearchCost, maxSearchSteps, ignoreStartingTerrainType);
        }
        ...
        /// <param name="maxSearchCost">Maximum search cost for the path finding algorithm. A value of -1 will use the global default defined by pathFindingMaxCost</param>
        /// <param name="ignoreStartingTerrainType">If true, the unit will be able to move one step ignoring the terrain type it's at the start position.</param>
        public List<Vector2> FindRoute(Vector2 startPosition, Vector2 endPosition, TERRAIN_CAPABILITY terrainCapability = TERRAIN_CAPABILITY.Any, float minAltitude = 0, float maxAltitude = 1f, float maxSearchCost = -1, int maxSearchSteps = -1, bool ignoreStartingTerrainType = true) {
            return FindRoute(startPosition, endPosition, out _, terrainCapability, minAltitude, maxAltitude, maxSearchCost, maxSearchSteps, ignoreStartingTerrainType);
        }
        ...
        /// <param name="maxSearchCost">Maximum search cost for the path finding algorithm. A value of -1 will use the global default defined by pathFindingMaxCost</param>
        /// <param name="ignoreStartingTerrainType">If true, the unit will be able to move one step ignoring the terrain type it's at the start position.</param>
        public IEnumerator FindRouteAsCoroutine(FindRouteASyncFinishMethod finished, Vector2 startPosition, Vector2 endPosition, TERRAIN_CAPABILITY terrainCapability = TERRAIN_CAPABILITY.Any, float minAltitude = 0, float maxAltitude = 1f, float maxSearchCost = -1, int maxSearchSteps = -1, bool ignoreStartingTerrainType = true) {
            List<Vector2> points = null;
            float totalCost = 0;

            Task find = Task.Run(() => points = FindRoute(startPosition, endPosition, out totalCost, terrainCapability, minAltitude, maxAltitude, maxSearchCost, maxSearchSteps, ignoreStartingTerrainType));
        ...
        /// <param name="maxSearchCost">Maximum search cost for the path finding algorithm. A value of -1 will use the global default defined by pathFindingMaxCost</param>
        /// <param name="ignoreStartingTerrainType">If true, the unit will be able to move one step ignoring the terrain type it's at the start position.</param>
        public List<Vector2> FindRoute(Vector2 startPosition, Vector2 endPosition, out float totalCost, TERRAIN_CAPABILITY terrainCapability = TERRAIN_CAPABILITY.Any, float minAltitude = 0, float maxAltitude = 1f, float maxSearchCost = -1, int maxSearchSteps = -1, bool ignoreStartingTerrainType = true) {
            totalCost = 0;
            ...
            try {
                ...
                if (Mathf.Abs(endingPoint.X - startingPoint.X) > 0 || Mathf.Abs(endingPoint.Y - startingPoint.Y) > 0) {
                    ...
                    finder.IgnoreStartingTerrainType = ignoreStartingTerrainType;
