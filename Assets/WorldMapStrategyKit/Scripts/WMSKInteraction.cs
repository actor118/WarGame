...
namespace WorldMapStrategyKit {
    ...
    public partial class WMSK : MonoBehaviour {
        ...
        public bool enableCameraOrbit {
            ...
            set {
                if (value != _enableCameraOrbit) {
                    ...
                    if (!_enableCameraOrbit) _orbitYawAngle = 0;
                    isDirty = true;
                }
            }
        }
        ...
        public float orbitYawAngle {
            get {
                return _orbitYawAngle;
            }
            set {
                if (value != _orbitYawAngle) {
                    _orbitYawAngle = value;
                    isDirty = true;
                }
            }
        }
        ...
        public void CenterMap() {
            ...
            if (cam != null) {
                cam.transform.position = _renderViewport.transform.position;
            }
