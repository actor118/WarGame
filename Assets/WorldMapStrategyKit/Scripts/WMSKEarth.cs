...
namespace WorldMapStrategyKit {
    ...
    public static class EarthStyleExtensions {
        ...
        public static bool supportsBumpMap(this EARTH_STYLE earthStyle) {
            return earthStyle == EARTH_STYLE.Natural || earthStyle == EARTH_STYLE.NaturalHighRes || earthStyle == EARTH_STYLE.Alternate1 || earthStyle == EARTH_STYLE.Alternate2 || earthStyle == EARTH_STYLE.Alternate3 || earthStyle == EARTH_STYLE.NaturalScenic || earthStyle == EARTH_STYLE.NaturalScenic8K || earthStyle == EARTH_STYLE.NaturalScenic16K;
        }
    }
