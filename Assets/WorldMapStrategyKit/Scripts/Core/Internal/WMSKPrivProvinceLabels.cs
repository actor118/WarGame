    ...
    public partial class WMSK : MonoBehaviour {
        ...
        void ReloadProvinceFont() {
            ...
            if (_provinceLabelsFont == null) {
                provLabelsFont = Resources.Load<Font>("WMSK/Font/Lato");
                if (provLabelsFont == null) return;
            } else {
                provLabelsFont = _provinceLabelsFont;
            }
            provLabelsFont = Instantiate(provLabelsFont);
            if (disposalManager != null) {
                disposalManager.MarkForDisposal(provLabelsFont);
            }
            ...
            if (disposalManager != null) disposalManager.MarkForDisposal(fontMaterial);
            provLabelsFont.material = fontMaterial;
            provLabelsShadowMaterial = Instantiate(fontMaterial);
            if (disposalManager != null) disposalManager.MarkForDisposal(provLabelsShadowMaterial);
        ...
        void DrawProvinceLabelsInt(Country country, Color color = default(Color)) {
            ...
            if (!isPlaying || !gameObject.activeInHierarchy || country == null || country.hidden || provinces == null || country.provinces == null || provLabelsFont == null)
                return;
