...
namespace WorldMapStrategyKit {
    ...
    public partial class WMSK : MonoBehaviour {
        ...
        static partial class ShaderParams {
            ...
            public static int SDFTexture = Shader.PropertyToID("_SDFTexture");
            public static int SDFBorderFallOff = Shader.PropertyToID("_SDFBorderFallOff");
            public static int SDFBorderColor = Shader.PropertyToID("_SDFBorderColor");

            public const string SKW_OUTLINE = "OUTLINE_ON";
            public const string SKW_VIEWPORT_UNLIT = "WMSK_VIEWPORT_UNLIT";
            public const string SKW_SDF_TEXTURE = "USE_SDF_TEXTURE";
            public const string SKW_WATER_MASK = "USE_MASK";
        }
    }
