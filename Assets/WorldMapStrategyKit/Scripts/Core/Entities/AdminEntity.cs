...
namespace WorldMapStrategyKit {
	...
	public abstract class AdminEntity: IAdminEntity, IExtendableAttribute {
		...
		public Region mainRegion {
			get {
				if (mainRegionIndex < 0 || _regions == null || mainRegionIndex >= _regions.Count)
					return null;
                else
                    return _regions[mainRegionIndex];
            }
        }
        ...
        /// </summary>
        public bool IsEmpty() {
			bool isEmpty = _regions == null || _regions.Count == 0 || _regions[0] == null || _regions[0].points == null || _regions[0].points.Length == 0;
			return isEmpty;
        }
