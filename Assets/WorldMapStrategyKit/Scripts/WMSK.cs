...
namespace WorldMapStrategyKit {
    ...
    public partial class WMSK : MonoBehaviour {
        ...
        public static WMSK instance {
            get {
                if (_instance == null) {
                    WMSK[] candidates = Misc.FindObjectsOfType<WMSK>(true);
                    WMSK miniMap = null;
                ...
                if (_instance != null && _instance.isActiveAndEnabled && _instance.countries == null) {
                    _instance.Init();
                }
                return _instance;
            }
        ...
        public Camera cameraMain {
            get {
                ...
                Camera[] cameras = Misc.FindObjectsOfType<Camera>(true);
        ...
        /// <summary>
        /// Returns a random coordinate within the viewport bounds
        /// </summary>
